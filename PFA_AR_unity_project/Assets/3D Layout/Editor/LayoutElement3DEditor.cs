...
public class LayoutElement3DEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUI.BeginChangeCheck();
        DrawDimensionGizmos =
            EditorGUILayout.Toggle(new GUIContent("Draw Dimension Gizmos"), Element.DrawDimensionGizmos);
    ...
    private const string ToolTip_ElemDimensions =
        "The size of this element in local space used to determine the distance between their pivot points in the layout.  Only used in Linear Layouts.";
}
}
#endif
